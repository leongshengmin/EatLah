...
import com.eatlah.eatlah.AcceptedOrderItemFragment.OnListFragmentInteractionListener;
...
public class AcceptedOrderItemRecyclerViewAdapter extends RecyclerView.Adapter<AcceptedOrderItemRecyclerViewAdapter.ViewHolder> {
    ...
    public AcceptedOrderItemRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
